...
<div class="tab-content" id="myTabContent">
  <div class="tab-pane fade show active" id="area1" role="tabpanel" aria-labelledby="area1-tab" style="text-align: center;">
  	<a href="search?type=SAT&keyword=%EA%B0%95%EB%8F%99%EA%B5%AC&pageNum=1&amount=16">
  	<button type="button" class="btn btn-warning">강동구</button>
  	</a>
  	<a href="search?type=SAT&keyword=강서구&pageNum=1&amount=16">
	<button type="button" class="btn btn-warning">강서구</button>
	</a>
	<a href="search?type=SAT&keyword=광진구&pageNum=1&amount=16">
	<button type="button" class="btn btn-warning">광진구</button>
	</a>
	<a href="search?type=SAT&keyword=구로구&pageNum=1&amount=16">
	<button type="button" class="btn btn-warning">구로구</button>
	</a>
	<a href="search?type=SAT&keyword=노원구&pageNum=1&amount=16">
	<button type="button" class="btn btn-warning">노원구</button>
	</a>
	<a href="search?type=SAT&keyword=도봉구&pageNum=1&amount=16">
	<button type="button" class="btn btn-warning">도봉구</button>
	</a>
	<a href="search?type=SAT&keyword=동대문구&pageNum=1&amount=16">
	<button type="button" class="btn btn-warning">동대문구</button>
	</a>
	<a href="search?type=SAT&keyword=동작구&pageNum=1&amount=16">
	<button type="button" class="btn btn-warning">동작구</button>
	</a>
	<a href="search?type=SAT&keyword=마포구&pageNum=1&amount=16">
	<button type="button" class="btn btn-warning">마포구</button>
	</a>
	<a href="search?type=SAT&keyword=서대문구&pageNum=1&amount=16">
	<button type="button" class="btn btn-warning">서대문구</button>
	</a>
	<a href="search?type=SAT&keyword=성동구&pageNum=1&amount=16">
	<button type="button" class="btn btn-warning">성동구</button>
	</a>
	<a href="search?type=SAT&keyword=성북구&pageNum=1&amount=16">
	<button type="button" class="btn btn-warning">성북구</button>
	</a>
	<a href="search?type=SAT&keyword=용산구&pageNum=1&amount=16">
	<button type="button" class="btn btn-warning">용산구</button>
	</a>
	<a href="search?type=SAT&keyword=서울+중구&pageNum=1&amount=16">
	<button type="button" class="btn btn-warning">중구</button>
	</a>
	<a href="search?type=SAT&keyword=중랑구&pageNum=1&amount=16">
  ...
  <div class="tab-pane fade" id="area2" role="tabpanel" aria-labelledby="area2-tab" style="text-align: center;">
     <a href="search?type=SAT&keyword=인천+서구&pageNum=1&amount=16"><button type="button" class="btn btn-warning">서구</button></a>
     <a href="search?type=SAT&keyword=인천+중구&pageNum=1&amount=16"><button type="button" class="btn btn-warning">중구</button></a>
  </div>
  <div class="tab-pane fade" id="area3" role="tabpanel" aria-labelledby="area3-tab" style="text-align: center;">
     <a href="search?type=SAT&keyword=군포시&pageNum=1&amount=16"><button type="button" class="btn btn-warning">군포시</button></a>
     <a href="search?type=SAT&keyword=부천시&pageNum=1&amount=16"><button type="button" class="btn btn-warning">부천시</button></a>
     <a href="search?type=SAT&keyword=성남시&pageNum=1&amount=16"><button type="button" class="btn btn-warning">성남시</button></a>
     <a href="search?type=SAT&keyword=수원시&pageNum=1&amount=16"><button type="button" class="btn btn-warning">수원시</button></a>
     <a href="search?type=SAT&keyword=평택시&pageNum=1&amount=16"><button type="button" class="btn btn-warning">평택시</button></a>
  </div>
  <div class="tab-pane fade" id="area4" role="tabpanel" aria-labelledby="area4-tab" style="text-align: center;">
     <a href="search?type=SAT&keyword=원주시&pageNum=1&amount=16"><button type="button" class="btn btn-warning">원주시</button></a>
  </div>
  <div class="tab-pane fade" id="area5" role="tabpanel" aria-labelledby="area5-tab" style="text-align: center;">
     <a href="search?type=SAT&keyword=서산시&pageNum=1&amount=16"><button type="button" class="btn btn-warning">서산시</button></a>
  </div>
  <div class="tab-pane fade" id="area6" role="tabpanel" aria-labelledby="area6-tab" style="text-align: center;">
     <a href="search?type=SAT&keyword=대전+동구&pageNum=1&amount=16"><button type="button" class="btn btn-warning">동구</button></a>
  </div>
  <div class="tab-pane fade" id="area7" role="tabpanel" aria-labelledby="area7-tab" style="text-align: center;">
     <a href="search?type=SAT&keyword=여수시&pageNum=1&amount=16"><button type="button" class="btn btn-warning">여수시</button></a>
  </div>
  <div class="tab-pane fade" id="area8" role="tabpanel" aria-labelledby="area8-tab" style="text-align: center;">
     <a href="search?type=SAT&keyword=거제시&pageNum=1&amount=16"><button type="button" class="btn btn-warning">거제시</button></a>
  </div>
  <div class="tab-pane fade" id="area9" role="tabpanel" aria-labelledby="area9-tab" style="text-align: center;">
     <a href="search?type=SAT&keyword=포항시&pageNum=1&amount=16"><button type="button" class="btn btn-warning">포항시</button></a>
  </div>
  <div class="tab-pane fade" id="area10" role="tabpanel" aria-labelledby="area10-tab" style="text-align: center;">
     <a href="search?type=SAT&keyword=서귀포시&pageNum=1&amount=16"><button type="button" class="btn btn-warning">서귀포시</button></a>
  </div>
</div>
...
<section class="py-5">
	<div class="container px-4 px-lg-5 mt-5">
		...
		<div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
			<c:forEach var="best1" items="${best1 }">
			<div class="col mb-5">
				<div class="card h-100">
					<!-- 음식 사진 -->
					<a href="/alleyboard/view?ano=${best1.ano }">
					...
					<div class="card-body p-4">
						<div class="text-center">
							<!-- 식당 이름 -->
							<h5 class="fw-bolder">
							<c:out value="${best1.storename }" />
							</h5>
							<!-- 식당 주소 -->
							<c:out value="${best1.address }" />
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
			<c:forEach var="best2" items="${best2 }">
			<div class="col mb-5">
				<div class="card h-100">
					<!-- 음식 사진 -->
					<a href="/alleyboard/view?ano=${best2.ano }">
					<img class="card-img-top"
						src="${best2.mainimage }" 
						style="height: 200px;" />
					</a>
					...
					<div class="card-body p-4">
						<div class="text-center">
							<!-- 식당 이름 -->
							<h5 class="fw-bolder">
							<c:out value="${best2.storename }" />
							</h5>
							<!-- 식당 주소 -->
							<c:out value="${best2.address }" />
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">		
			<c:forEach var="best3" items="${best3 }">
			<div class="col mb-5">
				<div class="card h-100">
					<!-- 음식 사진 -->
					<a href="/alleyboard/view?ano=${best3.ano }">
					<img class="card-img-top"
						src="${best3.mainimage }" 
						style="height: 200px;" />
					</a>
					...
					<div class="card-body p-4">
						<div class="text-center">
							<!-- 식당 이름 -->
							<h5 class="fw-bolder">
							<c:out value="${best3.storename }" />
							</h5>
							<!-- 식당 주소 -->
							<c:out value="${best3.address }" />
						</div>
					</div>
				</div>
			</div>
